# Specification: filtrar-voluntariados-tipo

## Purpose
Permitir a los voluntarios filtrar los voluntariados por tipo para escoger de manera rápida y eficiente los de su interés en la plataforma Kellun.
